...
Entonces la carencia que presentan los multirrotores es la capacidad de ser reactivos ante eventos que ocurran en el entorno, si estos pudieran reaccionar frente a estos sin ser previstos de antemano al momento de planificar el vuelo los cuadricopteros podrían ampliar su rango de aplicaciones.\\
...
\subsection{Sensor óptico de movimiento}
...
\begin{figure}[H]
  ...
  \caption{Señal \emph{PWM} de distintos canales, el pulso tiene una tiempo de duracion minimo de 1000$\mu$s y maximo de 2000$\mu$s.}
  \label{fig:pwm}
\end{figure}
